function tumblrNotesInserted() {
    ...
    var l = function (t, n) {
        ...
        this.set_embed_size(e('.video-wrapper iframe[src^="//instagram"]'));
    ...
    l.prototype = {
        ...
        _append_new_posts: function (t) {
            ...
            this.set_embed_size(r.find('.video-wrapper iframe[src^="//instagram"]'));
        ...
        set_embed_size: function (t) {
            t.each(function () {
                ...
                if (!t.data("aspect-ratio")) {
                    ...
                    var r = 710;
                    var i = r / n;
                    t.attr("data-aspect-ratio", i);
                    t.width(n);
                    t.height(r)
                }
                e(this).parent().addClass("video-embed")
            })
        },
        ...
        hide_loader: function (e) {
            if (e) this.config.$pagination.hide();
